! function(e, t) {
  ...
  try {
    !(function() {
      ...
      var t, a, n = e(ht);
      (dt = t = t || {})[dt.DEBUG = 0] = "DEBUG", dt[dt.VERBOSE = 1] = "VERBOSE", dt[dt.INFO = 2] = "INFO", dt[dt.WARN = 3] = "WARN", dt[dt.ERROR = 4] = "ERROR", dt[dt.SILENT = 5] = "SILENT";
      const r = {
          debug: t.DEBUG,
          verbose: t.VERBOSE,
          info: t.INFO,
        ...
        return new Promise((t, n) => {
          try {
            ...
            r.onsuccess = () => {
              ...
              var e;
              n((null === (e = r.error) || void 0 === e ? void 0 : e.message) || "")
            }
          } catch (e) {
            n(e)
          }
      ...
      function y(e, t = h, n = m) {
        var a = t * Math.pow(n, e),
          r = Math.round(w * a * (Math.random() - .5) * 2);
      ...
      function N(a) {
        return a !== IDBDatabase.prototype.transaction || "objectStoreNames" in IDBTransaction.prototype ? (T = T || [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey]).includes(a) ? function(...e) {
      ...
      function A(e) {
        return "function" == typeof e ? N(e) : (e instanceof IDBTransaction && (i = e, C.has(i) || (t = new Promise((e, t) => {
          const n = () => {
              i.removeEventListener("complete", a), i.removeEventListener("error", r), i.removeEventListener("abort", r)
            },
            a = () => {
              e(), n()
            },
          ...
          i.addEventListener("complete", a), i.addEventListener("error", r), i.addEventListener("abort", r)
        }), C.set(i, t))), E(e, _ = _ || [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction]) ? new Proxy(e, P) : e);
        var i, t
      }
      ...
      function k(e) {
        if (e instanceof IDBRequest) return function(i) {
          const e = new Promise((e, t) => {
            const n = () => {
                i.removeEventListener("success", a), i.removeEventListener("error", r)
              },
              a = () => {
                e(k(i.result)), n()
              },
      ...
      function B(e, t) {
        if (e instanceof IDBDatabase && !(t in e) && "string" == typeof t) {
          ...
          const r = t.replace(/FromIndex$/, ""),
            i = t !== r,
            o = M.includes(r);
          if (r in (i ? IDBIndex : IDBObjectStore).prototype && (o || j.includes(r))) {
            var n = async function(e, ...t) {
              var n = this.transaction(e, o ? "readwrite" : "readonly");
              let a = n.store;
              return i && (a = a.index(t.shift())), (await Promise.all([a[r](...t), o && n.done]))[0]
            };
            return $.set(t, n), n
          }
        }
      ...
      function oe(e, t) {
        ...
        se(n, t),
          function(e, t) {
            const n = function() {
              !ce && "BroadcastChannel" in self && (ce = new BroadcastChannel("[Firebase] FID Change"), ce.onmessage = e => {
      ...
      function de() {
        return ue = ue || function(e, t, {
          ...
          return a && o.addEventListener("upgradeneeded", e => {
            a(k(o.result), e.oldVersion, e.newVersion, k(o.transaction), e)
      ...
      async function pe(e, t) {
        ...
        const a = await de(),
          ...
          i = r.objectStore(le);
        var o = await i.get(n);
        return await i.put(t, n), await r.done, o && o.fid === t.fid || oe(e, t.fid), t
      }
      async function fe(e) {
        var t = re(e);
        const n = await de(),
      ...
      async function ge(e, t) {
        ...
        var o = await i.get(n),
          s = t(o);
        return void 0 === s ? await i.delete(n) : await i.put(s, n), await r.done, !s || o && o.fid === s.fid || oe(e, s.fid), s
      }
      async function he(n) {
        let a;
            ...
            t = function(e, t) {
              {
                if (0 !== t.registrationStatus) return 1 === t.registrationStatus ? {
                  ...
                  registrationPromise: async function(e) {
                    ...
                    for (; 1 === t.registrationStatus;) await ee(100), t = await me(e.appConfig);
                  ...
                  n = async function(t, n) {
                    try {
                      var e = await async function({
                        ...
                        !i || (o = await i.getHeartbeatsHeader()) && r.append("x-firebase-client", o);
                        var o = {
                          fid: n,
                          authVersion: q,
                          appId: e.appId,
                      ...
                      throw K(e) && 409 === e.customData.serverCode ? await fe(t.appConfig) : await pe(t.appConfig, {
                        fid: n.fid,
                        registrationStatus: 0
                      }), e
                    }
      ...
      function ve(e) {
        return 1 === (t = e).registrationStatus && t.registrationTime + x < Date.now() ? {
          fid: e.fid,
          registrationStatus: 0
        } : e;
        var t
      ...
      async function we({
        ...
        const a = ([r, i] = [e, n["fid"]], `${z(r)}/${i}/authTokens:generate`);
        var r, i;
        const o = Z(e, n),
          s = t.getImmediate({
            optional: !0
      ...
      async function ye(a, r = !1) {
        ...
        var e = await ge(a.appConfig, e => {
          ...
          var t, n = e.authToken;
          if (r || 2 !== (t = n).requestStatus || function(e) {
              var t = Date.now();
              return t < e.creationTime || e.creationTime + e.expiresIn < t + W
            }(t)) {
            if (1 === n.requestStatus) return i = async function(e, t) {
              let n = await Ie(e.appConfig);
              for (; 1 === n.authToken.requestStatus;) await ee(100), n = await Ie(e.appConfig);
              var a = n.authToken;
            ...
            return i = async function(t, n) {
              try {
                ...
                throw !K(e) || 401 !== e.customData.serverCode && 404 !== e.customData.serverCode ? (a = Object.assign(Object.assign({}, n), {
                  authToken: {
                    requestStatus: 0
                  }
                }), await pe(t.appConfig, a)) : await fe(t.appConfig), e
              }
            }(a, n), n
          }
          return e
      ...
      function Ie(e) {
        return ge(e, e => {
          if (!be(e)) throw G.create("not-registered");
          var t, n = e.authToken;
          return 1 === (t = n).requestStatus && t.requestTime + x < Date.now() ? Object.assign(Object.assign({}, e), {
            authToken: {
              requestStatus: 0
            }
          }) : e
      ...
      async function Ee(e, t = !1) {
        var n, a = e;
        return await ((n = (await he(a)).registrationPromise) && await n), (await ye(a, t)).token
      }
      ...
      const Te = "installations",
        Se = e => {
          ...
          return {
            ...
            heartbeatServiceProvider: mt._getProvider(t, "heartbeat"),
            _delete: () => Promise.resolve()
          }
        },
        Ce = e => {
          var t = e.getProvider("app").getImmediate();
          const n = mt._getProvider(t, Te).getImmediate();
          return {
      ...
      mt._registerComponent(new b(Te, Se, "PUBLIC")), mt._registerComponent(new b("installations-internal", Ce, "PRIVATE")), mt.registerVersion(F, H), mt.registerVersion(F, H, "esm2017");
      const De = "analytics",
        Le = "firebase_id",
        Oe = "origin",
        ...
        Ae = new class {
          constructor(e) {
            this.name = e, this._logLevel = i, this._logHandler = s, this._userLogHandler = null
          }
          get logLevel() {
      ...
      function Re(e) {
        ...
        var t = ke.create("invalid-gtag-resource", {
          gtagURL: e
        });
      ...
      function Me(e, t) {
        ...
        var r = `${Ne}?l=${e}&id=${t}`;
        a.src = n ? null === n || void 0 === n ? void 0 : n.createScriptURL(r) : r, a.async = !0, document.head.appendChild(a)
      }

      function $e(d, p, f, g) {
        return async function(e, ...t) {
          try {
            var n, a, r, i, o, s, c, l, u;
            "event" === e ? ([n, a] = t, await async function(e, n, a, r, i) {
              try {
                let t = [];
                if (i && i.send_to) {
                  let e = i.send_to;
                ...
                0 === t.length && (t = Object.values(n)), await Promise.all(t), e("event", r, i || {})
              } catch (e) {
                Ae.error(e)
              }
            }(d, p, f, n, a)) : "config" === e ? ([r, i] = t, await async function(e, t, n, a, r, i) {
              var o = a[r];
              try {
                if (o) await t[o];
                else {
              ...
              e("config", r, i)
            }(d, p, f, g, r, i)) : "consent" === e ? ([o] = t, d("consent", "update", o)) : "get" === e ? ([s, c, l] = t, d("get", s, c, l)) : "set" === e ? ([u] = t, d("set", u)) : d(e, ...t)
          } catch (e) {
            Ae.error(e)
          }
        }
      ...
      async function He(e) {
        ...
        if (200 === r.status || 304 === r.status) return r.json();
        {
          ...
          try {
            var i = await r.json();
            null !== (t = i.error) && void 0 !== t && t.message && (e = i.error.message)
          } catch (e) {}
      ...
      async function xe(e, t = Fe, n) {
        ...
        return setTimeout(async () => {
          s.abort()
        }, void 0 !== n ? n : 6e4), async function t(n, {
          ...
          try {
            ...
            if (c) return Ae.warn("Timed out fetching this Firebase app's measurement ID from the server." + ` Falling back to the measurement ID ${c}` + ` provided in the "measurementId" field in the local Firebase config. [${null==e?void 0:e.message}]`), {
              appId: s,
              measurementId: c
            };
            throw e
          ...
          try {
            ...
            const u = e;
            if (!qe(u)) {
              if (i.deleteThrottleMetadata(s), c) return Ae.warn("Failed to fetch this Firebase app's measurement ID from the server." + ` Falling back to the measurement ID ${c}` + ` provided in the "measurementId" field in the local Firebase config. [${null===u||void 0===u?void 0:u.message}]`), {
                appId: s,
                measurementId: c
              };
              throw e
            }
            const d = 503 === Number(null === (o = null === u || void 0 === u ? void 0 : u.customData) || void 0 === o ? void 0 : o.httpStatus) ? y(a, i.intervalMillis, Be) : y(a, i.intervalMillis),
              p = {
                throttleEndTimeMillis: Date.now() + d,
                backoffCount: a + 1
              };
            return i.setThrottleMetadata(s, p), Ae.debug(`Calling attemptFetch again in ${d} millis`), t(n, p, r, i)
          }
        }({
          appId: a,
          apiKey: r,
      ...
      function Ve(r, i) {
        return new Promise((e, t) => {
          ...
          r.addEventListener(() => {
            clearTimeout(a), t(ke.create("fetch-throttle", {
      ...
      async function We(t, e, n, a, r, i, o) {
        const s = xe(t);
        s.then(e => {
          n[e.measurementId] = e.appId, t.options.measurementId && e.measurementId !== t.options.measurementId && Ae.warn(`The measurement ID in the local Firebase config (${t.options.measurementId})` + ` does not match the measurement ID fetched from the server (${e.measurementId}).` + " To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.")
        }).catch(e => Ae.error(e)), e.push(s);
        var c = async function() {
          if (!p()) return Ae.warn(ke.create("indexeddb-unavailable", {
            errorInfo: "IndexedDB is not available in this environment."
          }).message), !1;
          try {
            await f()
          } catch (e) {
            return Ae.warn(ke.create("indexeddb-unavailable", {
        ...
        }(i) && Me(i, l.measurementId), r("js", new Date);
        const d = null !== (c = null == o ? void 0 : o.config) && void 0 !== c ? c : {};
        return d[Oe] = "firebase", d.update = !0, null != u && (d[Le] = u), r("config", l.measurementId, d), l.measurementId
      }
      class Ge {
        constructor(e) {
          this.app = e
      ...
      function tt(e) {
        ...
        e.dataLayerName && (Ye = e.dataLayerName), e.gtagName && (Xe = e.gtagName)
      }
      ...
      function nt(e, t, n) {
        ! function() {
          const e = [];
          var t;
          c() && e.push("This is a browser extension environment."), l() || e.push("Cookies are not available."), 0 < e.length && (t = e.map((e, t) => `(${t+1}) ${e}`).join(" "), t = ke.create("invalid-analytics-context", {
            errorInfo: t
          }), Ae.warn(t.message))
        }();
        var a, r, i = e.options.appId;
        ...
        if (null != Ke[i]) throw ke.create("already-exists", {
          id: i
        });
        return et || (function(e) {
          ...
          return window[r] && "function" == typeof window[r] && (i = window[r]), window[r] = $e(i, e, t, n), {
            gtagCore: i,
            wrappedGtag: window[r]
          }
        }(Ke, ze, Je, Ye, Xe), Qe = a, Ze = r, et = !0), Ke[i] = We(e, ze, Je, t, Ze, Ye, n), new Ge(e)
      }
      async function at() {
        if (c()) return !1;
        if (!l()) return !1;
      ...
      function ct(e, t, n, a) {
        e = I(e), async function(e, t, n, a, r) {
          var i;
          r && r.global ? e("event", n, a) : (i = await t, e("event", n, Object.assign(Object.assign({}, a), {
            send_to: i
          })))
        }(Qe, Ke[e.app.options.appId], t, n, a).catch(e => Ae.error(e))
      }
      const lt = "@firebase/analytics";
      mt._registerComponent(new b(De, (e, {
        options: t
      }) => {
        return nt(e.getProvider("app").getImmediate(), e.getProvider("installations-internal").getImmediate(), t)
      }, "PUBLIC")), mt._registerComponent(new b("analytics-internal", function(e) {
        try {
          const a = e.getProvider(De).getImmediate();
          return {
            logEvent: (e, t, n) => ct(a, e, t, n)
          }
        } catch (e) {
          throw ke.create("interop-component-reg-failed", {
            reason: e
          })
        }
      }, "PRIVATE")), mt.registerVersion(lt, "0.10.0"), mt.registerVersion(lt, "0.10.0", "esm2017");
      var ut, dt, pt;
      class ft {
        constructor(e, t) {
      ...
      pt = {
        ...
        isSupported: at,
        EventName: ut
      }, n.default.INTERNAL.registerComponent(new b("analytics-compat", gt, "PUBLIC").setServiceProps(pt).setMultipleInstances(!0)), n.default.registerVersion("@firebase/analytics-compat", "0.2.6")
    }).apply(this, arguments)
  } catch (e) {
    throw console.error(e), new Error("Cannot instantiate firebase-analytics-compat.js - be sure to load firebase-app.js first.")
  }
});
