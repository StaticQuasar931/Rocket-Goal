! function(e, t) {
  ...
  Z = "", ie(new _("platform-logger", e => new Y(e), "PRIVATE")), ie(new _("heartbeat", e => new we(e), "PRIVATE")), pe(X, "0.9.16", Z), pe(X, "0.9.16", "esm2017"), pe("fire-js", "");
  ...
  const Te = Ne;
  pe("@firebase/app-compat", "0.2.16", void 0);
  return Te.registerVersion("firebase", "10.2.0", "app-compat-cdn"), Te
});
